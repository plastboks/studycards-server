...
public class ColloquiumResource implements IResource<Colloquium>
{
    @Autowired
    private ColloquiumService colloquiumService;

    private static final String RESOURCE_NAME = "colloquiums";

    @Override
    @RequestMapping(value = RESOURCE_NAME, method = RequestMethod.POST)
    public ResponseEntity<Colloquium> post(Colloquium colloquium) throws URISyntaxException {
        return null;
    }

    @Override
    @RequestMapping(value = RESOURCE_NAME+"/{id}", method = RequestMethod.GET)
    public ResponseEntity<Colloquium> get(@PathVariable int id) {
        return null;
    }

    @Override
    @RequestMapping(value = RESOURCE_NAME, method = RequestMethod.PUT)
    public ResponseEntity<Colloquium> put(Colloquium colloquium) throws URISyntaxException {
        return null;
    }
